...
<style>
    * {
    ...
    .banner {
        ...
        height: 62%;
        transform: translate3d(0px, -60.046px, 0px);
        margin-top: 6%;
        width: 100%;
    }
...
<?php include 'form.php'; ?>
    ...
    <div class="address-main">
        <div class="main-box">
            <div class="box1">
                ...
                <h4>Address</h4>
                <span>Ramdayalu road, Muzaffarpur 842002, Bihar, India</span>
            </div>
            <div class="box1">
                <div class="img"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                        viewBox="0 0 172 172" style=" fill:#000000;">
            ...
            <div class="box1">
                <div class="img"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                        ...
                        <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
                            ...
                            <g fill="#000000">
                                <path
                                    d="M51.6,10.32c-5.66037,0 -10.32,4.65964 -10.32,10.32v9.74219c-0.0614,0.37149 -0.0614,0.75054 0,1.12203v105.51797c-0.0614,0.37149 -0.0614,0.75054 0,1.12203v13.21578c0,5.66037 4.65963,10.32 10.32,10.32h68.8c5.66037,0 10.32,-4.65963 10.32,-10.32v-13.18219c0.0614,-0.37149 0.0614,-0.75054 0,-1.12203v-16.65578h-6.88v13.76h-75.68v-99.76h75.68v13.76h6.88v-16.62219c0.0614,-0.37149 0.0614,-0.75054 0,-1.12203v-9.77578c0,-5.66036 -4.65963,-10.32 -10.32,-10.32zM51.6,17.2h68.8c1.90763,0 3.44,1.53236 3.44,3.44v6.88h-75.68v-6.88c0,-1.90764 1.53237,-3.44 3.44,-3.44zM79.12,55.04v3.44v55.04h82.56v-58.48zM86.81969,61.92h67.15391c-1.22503,1.06792 -27.50029,23.97201 -29.73047,25.91422c-1.59346,1.39009 -3.15017,1.60578 -3.84313,1.60578c-0.68741,0 -2.24822,-0.21923 -3.84313,-1.60578c-2.23071,-1.94266 -28.5241,-24.857 -29.73719,-25.91422zM154.8,70.32515v25.96125l-15.61437,-12.34906c7.0122,-6.11151 12.33121,-10.75005 15.61437,-13.61219zM86,70.33187c3.28225,2.86112 8.5969,7.49522 15.60765,13.60547l-15.60765,12.34234zM106.88187,88.53297c1.61005,1.40312 4.76359,4.15548 5.15328,4.49485h0.00672c2.98701,2.59696 6.19722,3.29219 8.35813,3.29219c2.15537,0 5.37622,-0.69172 8.36485,-3.2989c0.38915,-0.33891 3.54008,-3.0881 5.14656,-4.48813l20.88188,16.51469l0.00672,-0.00672v1.59906h-68.8v-1.59906l0.00672,0.00672zM48.16,141.04h75.68v10.32c0,1.90763 -1.53237,3.44 -3.44,3.44h-68.8c-1.90763,0 -3.44,-1.53237 -3.44,-3.44zM75.68,144.48c-1.24059,-0.01754 -2.39452,0.63425 -3.01993,1.7058c-0.62541,1.07155 -0.62541,2.39684 0,3.46839c0.62541,1.07155 1.77935,1.72335 3.01993,1.7058h20.64c1.24059,0.01754 2.39452,-0.63425 3.01993,-1.7058c0.62541,-1.07155 0.62541,-2.39684 0,-3.46839c-0.62541,-1.07155 -1.77935,-1.72335 -3.01993,-1.7058z">
                                </path>
                            </g>
                        </g>
                    </svg></div>
                <h4>Email</h4>
                <span>puzzelsteam@gmail.com</span>
            </div>
        </div>
    ...
    <div class="connect-main">
        ...
        <div class="subhead">Got a query? fill in the form we shall get back to you.</div>
    </div>
    <!-- form start //  -->
    <div class="form-form-main">
        <form action="contact.php" method="POST">
            ...
            <div class="second">
                ...
                <input type="number" name="number" id="email" placeholder="Number" required>
            </div>
            <input type="text" name="message" id="Requirment" placeholder="Message" required>
